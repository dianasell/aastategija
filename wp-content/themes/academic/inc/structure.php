...
if ( ! function_exists( 'academic_copyright' ) ) :
	...
	function academic_copyright() { 
	    ...
	    <div class="site-info copyright text-center">
	    	<div class="container">
	      		<?php echo sprintf( _x( '&copy; Aasta tegija %1$s', '', '' ), date( 'Y' ) ) . ' ' . esc_html( $theme_data->get( 'Name') ) . '&nbsp;' . esc_html__( 'by', 'academic' ). '&nbsp;<a target="_blank" href="'. esc_url( $theme_data->get( 'AuthorURI' ) ) .'">'. esc_html( $theme_data->get( 'Author' ) ) .'</a>';
