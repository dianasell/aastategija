	...
	<?php if(sizeof($templates)):?>
		<table class="widefat">
			...
			<?php foreach($templates as $template):
				...
				<tr class="<?php echo $class?>"><td><?php echo $template->name?></td><td><a href="admin.php?page=daskal_templates&do=edit&id=<?php echo $template->id?>"><?php _e('Edit/Delete', 'daskal')?></a></td></tr>
			<?php endforeach;?>
		</table>
	<?php endif;?>
</div>